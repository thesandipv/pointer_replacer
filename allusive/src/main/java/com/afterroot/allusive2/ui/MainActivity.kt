          ...
          OnCompleteListener { tokenTask ->
            ...
            userRef.get().addOnCompleteListener { getUserTask ->
              if (getUserTask.isSuccessful) {
                ...
                } else if (getUserTask.result!![DatabaseFields.FIELD_FCM_ID] !=
                  tokenTask.result
                ) {
                  userRef.update(DatabaseFields.FIELD_FCM_ID, tokenTask.result)
                } else if (getUserTask.result!![DatabaseFields.FIELD_VERSION] ==
                  null
                ) {
...
*/
  ...
  override fun onSupportNavigateUp(): Boolean =
    findNavController(R.id.fragment_repo_nav).navigateUp(appBarConfiguration)
